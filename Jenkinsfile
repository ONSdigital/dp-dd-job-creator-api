...
node {
    ...
    stage('Bundle') {
        ...
        sh "tar -cvzf dp-dd-job-creator-api-${revision}.tar.gz appspec.yml scripts/codedeploy"
        sh "aws s3 cp dp-dd-job-creator-api-${revision}.tar.gz s3://${env.S3_REVISIONS_BUCKET}/"
    }
