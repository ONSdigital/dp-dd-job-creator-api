...
sed dp-dd-job-creator-api/appspec.yml dp-dd-job-creator-api/scripts/codedeploy/* -i \
...
cp dp-dd-job-creator-api/appspec.yml artifacts/
cp dp-dd-job-creator-api/scripts/codedeploy/* artifacts/scripts/codedeploy
